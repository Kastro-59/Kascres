(function(d, D) {
    ...
    d.fn.kastroradio = function(m) {
        ...
        w ? this.each(function() {
            var G = d(this).data("kastroradio"),
                F = G && d.isFunction(G[m]) ? G[m].apply(G, t) : G;
            if (F !== G && F !== D) return K = F, !1
        }) : this.each(function() {
            d(this).data("kastroradio", new d.kastroradio(this,
                m))
        });
        return K
    };
    d.kastroradio = function(m, w) {
        function t(b, a) {
        ...
        function P() {
            ...
            b.innerHTML = "";
            d("#" + c).addClass("kastroaudioplayer").css({
                overflow: "hidden",
                display: "block"
            });
        ...
        */
        ...
        function Aa() {
            d.ajax({
                ...
                method: "GET",
                crossDomain: !0,
                url: "https://api.streamafrica.net/zeno/index.php?z=" + ub ,
                success: function(b) {
                    try {
                        var a = JSON.parse(b);
                        p(a.currentArtist + " - " + a.currentSong, a.title, a.thumb)
                    } catch (h) {
                        p("", "")
                    }
                },
        ...
        function nb(b) {
            ...
            d("#" + c + "textradioname").css({
                ...
                "font-family": aa,
                color: x
            }).addClass(c + "textradioname").html(d("." + c + "textradionamespan")).kastroradiodisableSelection();
            m = document.createElement("span");
            ...
            d("#" + c + "texttitle").css({
                ...
                "font-family": aa,
                color: x
            }).addClass(c + "texttitle").html(d("." + c + "texttitlespan")).kastroradiodisableSelection();
            m = document.createElement("div");
            ...
            d("#" +
                ...
                "font-family": "Roboto",
                color: x
            }).html("100").kastroradiodisableSelection();
            xb(a);
            yb(a);
        ...
        function Wa(b) {
            if ("true" == zb) {
                var a = "";
                "small" == ja && (a = "small");
                b && d("#" + c + a + "texttitle").hasClass(c + "Marquee") && (d("#" + c + a + "texttitle").removeClass(c + "Marquee"), d("#" + c + a + "texttitle").html(d("." + c + a + "texttitlespan").first()), d("#" + c + a + "texttitle").data("kastroradioMarquee").pause());
                d("#" + c + a + "textradioname").width() > d("." +
                    c + a + "textradionamespan").first().width() ? d("#" + c + a + "textradioname").hasClass(c + "Marquee") && (d("#" + c + a + "textradioname").removeClass(c + "Marquee"), d("#" + c + a + "textradioname").html(d("." + c + a + "textradionamespan").first()), d("#" + c + a + "textradioname").data("kastroradioMarquee").pause()) : d("#" + c + a + "textradioname").hasClass(c + "Marquee") || (d("#" + c + a + "textradioname").addClass(c + "Marquee"), d("#" + c + a + "textradioname").html(d("." + c + a + "textradionamespan").first()), d("#" + c + a + "textradioname").kastroradioMarquee());
                d("#" +
                    c + a + "texttitle").width() > d("." + c + a + "texttitlespan").first().width() ? d("#" + c + a + "texttitle").hasClass(c + "Marquee") && (d("#" + c + a + "texttitle").removeClass(c + "Marquee"), d("#" + c + a + "texttitle").html(d("." + c + a + "texttitlespan").first()), d("#" + c + a + "texttitle").data("kastroradioMarquee").pause()) : d("#" + c + a + "texttitle").hasClass(c + "Marquee") || (d("#" + c + a + "texttitle").addClass(c + "Marquee"), d("#" + c + a + "texttitle").html(d("." + c + a + "texttitlespan").first()), d("#" + c + a + "texttitle").kastroradioMarquee())
            }
        }
        ...
        function yb(b) {
            ...
            d("#" + c + "buttonpause").css({
                ...
                d(this).css("fill", x)
            }).fadeOut(0).kastroradiodisableSelection();
            b = document.createElement("div");
        ...
        function wb(b) {
            ...
            d("#" + c + "coverwrapper").css({
                position: "absolute",
                overflow: "hidden",
                background: "transparent(" + n(x).r + ", " + n(x).g + ", " + n(x).b + ", 0.1)"
            }).on("click",
                function() {
                    "" != pa && window.open(pa)
                }).kastroradiodisableSelection();
        ...
        function ob(b) {
            ...
            d("#" + c + "smalliconvolume").css({
                position: "absolute",
                fill: "rgba(" + n(x).r + ", " + n(x).g + ", " + n(x).b + ", 0.3)"
css({
                ...
                "font-family": aa,
                color: x
            }).addClass(c + "smalltextradioname").html(d("." + c + "smalltextradionamespan")).kastroradiodisableSelection();
            b = document.createElement("span");
            ...
            d("#" + c + "smalltexttitle").css({
                ...
                "font-family": aa,
                color: x
            }).addClass(c + "smalltexttitle").html(d("." + c + "smalltexttitlespan")).kastroradiodisableSelection();
            b = document.createElement("div");
        ...
        function Ka() {
            E("playmode");
            try {
                d(".kastroaudioplayer").each(function() {
                    d(this).attr("id") != c && d(this).data("kastroradio").pause()
                })
            } catch (b) {
                E(b)
            }
        ...
        if (arguments.length) {
            ...
            var Kb = this;
            this.element.bind("remove.kastroradio", function() {
                Kb.destroy()
            })
        }
        ...
        d(document).ready(function() {
            var b = document.getElementsByTagName("script"),
                a, h;
            for (a = 0; h = b[a]; a++)
                if (h = h.src, 0 <= h.indexOf("kastroradio.min.js")) var f = h.substring(0, h.indexOf("kastroradio.min.js"));
            Y = f;
            E("SCRIPT FOLDER: " + Y);
            c = Jb;
            C = d("#" + c).width();
        ...
        jQuery.fn.extend({
            kastroradiodisableSelection: function() {
                this.each(function() {
...
(function(d, D) {
    var m = {
        ...
        G = {
            browser: [
                ...
                [/(kindle)\/([\w\.]+)/i, /(kastroscape|maxthon|netfront|jasmine|blazer)[\/\s]?([\w\.]*)/i, /(avant\s|iemobile|slim)(?:browser)?[\/\s]?([\w\.]*)/i, /(bidubrowser|baidubrowser)[\/\s]?([\w\.]+)/i, /(?:ms|\()(ie)\s([\w\.]+)/i, /(rekonq)\/([\w\.]*)/i, /(chromium|flock|rockmelt|midori|epiphany|silk|skyfire|ovibrowser|bolt|iron|vivaldi|iridium|phantomjs|bowser|quark|qupzilla|falkon)\/([\w\.-]+)/i],
                ["name", "version"],
                [/(konqueror)\/([\w\.]+)/i],
                [
    ...
    "undefined" !== typeof exports ? ("undefined" !== typeof module && module.exports && (exports = module.exports =
        F), exports.kastroradioParser = F) : "function" === typeof define && define.amd ? define(function() {
        return F
    }) : d && (d.kastroradioParser = F);
...
(function(d, D) {
    ...
    d.fn.kastroradioMarquee = function(m) {
        var w = "string" === typeof m,
            t = Array.prototype.slice.call(arguments, 1),
            K = this;
        m = !w && t.length ? d.extend.apply(null, [!0, m].concat(t)) : m;
        if (w && "_" === m.charAt(0)) return K;
        w ? this.each(function() {
            var G = d(this).data("kastroradioMarquee"),
                F = G && d.isFunction(G[m]) ? G[m].apply(G, t) : G;
            if (F !== G && F !== D) return K = F, !1
        }) : this.each(function() {
            d(this).data("kastroradioMarquee",
                new d.kastroradioMarquee(this, m))
        });
        return K
    };
    d.kastroradioMarquee = function(m, w) {
        function t() {
            var p = N ? -1 : 1,
                y = N ? -1 * G : 0;
...
(function(d) {
    ...
    var P = d.extend;
    m._binds = [];
    d.fn.kastroradiograb = function(e, p) {
    ...
    d.fn.kastroradioungrab = function(e) {
        return this.each(function() {
